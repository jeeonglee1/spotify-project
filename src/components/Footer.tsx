  ...
  return (
    <footer className="bg-zinc-800 border-t border-zinc-700 px-6 py-2 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Image src={"/ariana.jpg"} width={56} height={56} alt={"Capa do álbum Dangerous Woman da cantora Ariana Grande"} />
          <div className="flex flex-col">
            <strong className="font-normal">Side to Side</strong>
        ...
        <div className="flex flex-col items-center gap-2">
          <div className="flex items-center gap-6">
            ...
            <button className="p-2 rounded-full bg-white text-black flex items-center justify-center w-9 h-9 pr-1">
                <Play fill="bg-black"/>
              </button>
